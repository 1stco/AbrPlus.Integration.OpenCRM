...
using AbrPlus.Integration.OpenCRM.Client.AbrPlus.Helper;
...
{
    public class LookupSourceApiPayamGostarClient : CallStoreApiAbrPlusClient, ILookupSourceApiClient
    {
        private readonly string _host;
        private readonly PasswordFlowAutorize _passwordFlow;
        ...
        {
            return new PayamgostarApiClientFactory<ICrmObjectTypeChannel>().Create(_host);
        }
        public ICrmObjectChannel CreateCrmObjectClient()
        {
            return new PayamgostarApiClientFactory<ICrmObjectChannel>().Create(_host);
        }
        public IIdentityChannel CreateIdentityClient()
        {
            return new PayamgostarApiClientFactory<IIdentityChannel>().Create(_host);
        }
        public IUserChannel CreateUserClient()
        {
            return new PayamgostarApiClientFactory<IUserChannel>().Create(_host);
        }
        public IContractChannel CreateContractClient()
        {
            return new PayamgostarApiClientFactory<IContractChannel>().Create(_host);
        }
        public IEpayChannel CreateEpayClient()
        {
            return new PayamgostarApiClientFactory<IEpayChannel>().Create(_host);
        }
        public IInvoiceChannel CreateInvoiceClient()
        {
            return new PayamgostarApiClientFactory<IInvoiceChannel>().Create(_host);
        }
        public IPaymentChannel CreatePaymnetClient()
        {
            return new PayamgostarApiClientFactory<IPaymentChannel>().Create(_host);
        }
        public IMoneyAccountChannel CreateMoneyAccountClient()
        {
            return new PayamgostarApiClientFactory<IMoneyAccountChannel>().Create(_host);
        }
        private PaymentResponse GetReceiptInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            {
                var paymentInfoResult = paymentChannel.SearchReceipt(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
        ...
        private PaymentResponse GetPaymentResultInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            using (var paymentChannel = CreatePaymnetClient())
            {
                var paymentInfoResult = paymentChannel.SearchPayment(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
                if (paymentInfoResult.Success &&
        ...
        private PaymentResponse GetQuoteInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            {
                var invoiceInfoResult = invoiceChannel.SearchQuote(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
        ...
        private PaymentResponse GetPurchaseInvoiceInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            using (var invoiceChannel = CreateInvoiceClient())
            {
                var invoiceInfoResult = invoiceChannel.SearchPurchaseInvoice(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
                if (invoiceInfoResult.Success &&
        ...
        private PaymentResponse GetReturnPurchaseInvoiceInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            using (var invoiceChannel = CreateInvoiceClient())
            {
                var invoiceInfoResult = invoiceChannel.SearchReturnPurchaseInvoice(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
                if (invoiceInfoResult.Success &&
        ...
        private PaymentResponse GetReturnSaleInvoiceInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            using (var invoiceChannel = CreateInvoiceClient())
            {
                var invoiceInfoResult = invoiceChannel.SearchReturnSaleInvoice(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
                if (invoiceInfoResult.Success &&
        ...
        private PaymentResponse GetPurchaseQuoteInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            using (var invoiceChannel = CreateInvoiceClient())
            {
                var invoiceInfoResult = invoiceChannel.SearchPurchaseQuote(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
                if (invoiceInfoResult.Success &&
        ...
        private PaymentResponse GetInvoiceInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            using (var invoiceChannel = CreateInvoiceClient())
            {
                var invoiceInfoResult = invoiceChannel.SearchInvoice(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                     billableObjectTypeKey,
                                                                     query);
                if (invoiceInfoResult.Success &&
        ...
        private PaymentResponse GetContractInfo(CustomerRequest customerRequest, string billableObjectTypeKey, string billableObjectNumber, string lookupNumberFieldKey, string valueFieldKey)
        {
            ...
            {
                var contractInfoResult = contractChannel.SearchContract(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                                        billableObjectTypeKey,
                                                                        query);
        ...
        public async Task<BillableObjectTypesResponse> GetBillableObjectTypes()
        {
            try
            {
                ...
                {
                    var lstCrmObjectType = crmObjectType.GetCrmObjectTypeList(_passwordFlow.UserName,
                                                                     _passwordFlow.Password, null);
        ...
        public async Task<MoneyAccountsResponse> GetMoneyAccounts()
        {
            try
            {
                ...
                {
                    var moneyAccountListInfo = moneyAccountChannel.GetMoneyAccountList(_passwordFlow.UserName, _passwordFlow.Password, 0, 50);
        ...
        public async Task<IdentityResponse> GetIdentityByCustomerInfo(CustomerRequest customerRequest)
        {
            try
            {
                ...
                if (Guid.TryParse(customerRequest.CustomerId, out customerId))
                {
                    ...
                    {
                        return await Task.FromResult(identityChannel.FindIdentityById(_passwordFlow.UserName, _passwordFlow.Password, customerId).IdentityInfo.ToDto());
                    }
                }
        ...
        public Task<IdentityResponse> GetIdentityByPhoneNumber(IdentityByPhoneNumberRequest identityByPhoneNumberRequest)
        {
            try
            {
                using (var identityChannel = CreateIdentityClient())
                {
                    return Task.FromResult(identityChannel.FindIdentityByPhoneNumber(_passwordFlow.UserName, _passwordFlow.Password, identityByPhoneNumberRequest.PhoneNumber).IdentityInfo.ToDto());
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<IdentityResponse> GetIdentityByCustomerNumber(IdentityByCustomerNumberRequest identityByCustomerNumberRequest)
        {
            try
            {
                using (var identityChannel = CreateIdentityClient())
                {
                    var result = identityChannel.SearchIdentity(_passwordFlow.UserName, _passwordFlow.Password, string.Empty,
        ...
        public async Task<IdentityContractStatusResponse> GetIdentityContractStatus(IdentityContractStatusRequest identityHasValidContractRequest)
        {
            try
            {
                using (var contractChannel = CreateContractClient())
                {
                    var contracts = contractChannel.SearchContract(_passwordFlow.UserName, _passwordFlow.Password, identityHasValidContractRequest.ContractKey,
                    ...
                    if (!contracts.Success)
                    {
                        ...
                        return await Task.FromResult(new IdentityContractStatusResponse { IsValid = false });
                    }
                    ...
                    foreach (var contract in contracts.ContractInfoList)
                    {
                        if (contract.EndDate != null)
                        {
                            if (contract.EndDate.Value.Date.AddDays(1) > DateTime.Now)
                            {
                                ...
                                {
                                    return await Task.FromResult(new IdentityContractStatusResponse { IsValid = true });
                                }
                                else
                                {
        ...
        public async Task<UserResponse> GetUserInfoByIdentityId(UserInfoByIdentityRequest userInfoByIdentityRequest)
        {
            try
            {
                ...
                {
                    return await Task.FromResult(userChannel.GetUserByIdentityId(_passwordFlow.UserName, _passwordFlow.Password, new Guid(userInfoByIdentityRequest.IdentityId)).ToDto());
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<UserTelephonySystemResponse> GetUserExtensions(UserExtensionsRequest userExtenstionsRequest)
        {
            ...
            try
            {
                using (var userChannel = CreateUserClient())
                {
                    return await Task.FromResult(userChannel.GetUserExtensions(_passwordFlow.UserName, _passwordFlow.Password, userExtenstionsRequest.Username).ToDto());
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<UserExtensionResponse> GetUserDefaultExtension(UserExtensionRequest userExtensionRequest)
        {
            ...
            try
            {
                using (var userChannel = CreateUserClient())
                {
                    var userTelephonySystemInfo = userChannel.GetUserExtensions(_passwordFlow.UserName, _passwordFlow.Password, userExtensionRequest.Username);
        ...
        public async Task<UserExtensionResponse> GetUserManagerExtension(UserManagerByExtensionRequest userManagerByExtensionRequest)
        {
            ...
            try
            {
                using (var userChannel = CreateUserClient())
                {
                    var result = userChannel.GetUserHelperExtensionBy(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
        ...
        public async Task<IdentityBalanceResponse> GetIdentityBalance(CustomerRequest customerRequest)
        {
            try
            {
                ...
                if (Guid.TryParse(customerRequest.CustomerId, out customerId))
                {
                    using (var identityChannel = CreateIdentityClient())
                    {
                        var identityInfoResult = identityChannel.FindIdentityById(_passwordFlow.UserName, _passwordFlow.Password, new Guid(customerRequest.CustomerId));
                        ...
                        {
                            return await Task.FromResult(new IdentityBalanceResponse { Balance = Math.Abs(identityInfoResult.IdentityInfo.Balance.Value) });
                        }
                    }
                }
            }
        ...
        public async Task<CardtableResponse> GetCardtable(CardtableRequest cardtableRequest)
        {
            ...
            try
            {
                ...
                {
                    return await Task.FromResult(crmObjectTypeChannel.GetCardtable(_passwordFlow.UserName,
                                                                     _passwordFlow.Password,
                                                             null,
                                                             null,
        ...
        public async Task<EncryptCrmObjectResponse> EncryptCrmObjectAsync(EncryptCrmObjectRequest encryptCrmObjectRequest)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var formContent = new FormUrlEncodedContent(new[]
                {
                  ...
                  new KeyValuePair<string, string>("username", _passwordFlow.UserName),
                  new KeyValuePair<string, string>("password", _passwordFlow.Password),
                });
        ...
        public async Task<BillableObjectTypePropsResponse> GetBillableObjectTypeProps(BillableObjectTypePropsRequest billableObjectTypePropsRequest)
        {
            try
            {
                using (var crmObjectType = CreateCrmObjectTypeClient())
                {
                    var crmObjectTypeInfo = crmObjectType.GetCrmObjectTypeInfo(_passwordFlow.UserName,
                                                                     _passwordFlow.Password, billableObjectTypePropsRequest.BillableObjectTypeKey);
        ...
        public async Task<PaymentResponse> GetPaymentInfo(PaymentInfoRequest paymentInfoRequest)
        {
            try
            {
                using (var crmObjectType = CreateCrmObjectTypeClient())
                {
                    var crmObjectTypeInfo = crmObjectType.GetCrmObjectTypeInfo(_passwordFlow.UserName, _passwordFlow.Password, paymentInfoRequest.BillableObjectTypeKey);
                    if (crmObjectTypeInfo != null)
                    {
        ...
        public async Task<SendPaymentLinkToUserResponse> SendPaymentLinkToUser(SendPaymentLinkToUserRequest sendPaymentLinkToUserRequest)
        {
            ...
            try
            {
                ...
                {
                    var paymentLinkInfoResult = epayChannel.CreatePaymentLink(_passwordFlow.UserName, _passwordFlow.Password, paymentLinkInfo);
        ...
        protected IPgClient MyIPgClient
        {
            get
            {
                ...
                {
                    _pgClient = Create(_host, _passwordFlow.UserName, _passwordFlow.Password);
